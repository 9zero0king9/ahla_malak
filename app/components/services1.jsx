...
import servicesp from '../assets/png/services.png';
    ...
    style={{
         ...
         <div className='flex h-full items-center rounded-t-4xl justify-end mr-27'>
          ...
          <div className=''>
                ...
                <h1 className='text-2xl font-bold text-black text-center'> ما بنحط قالب واحد للكل كل زبونة الها عندنا قصتها الخاصة وإطلالتها اللي بتميزها </h1>
                <Link href='/'>
